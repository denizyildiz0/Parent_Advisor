...
class AtistirmalikTarifScreen extends StatefulWidget {
  const AtistirmalikTarifScreen({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                InkWell(
                  onTap: () {
                    Navigator.pushNamed(context, '/bebek');
                  },
                  child: Container(
                    width: 150,
                    height: 200,
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                        color:  Color.fromARGB(255, 48, 13, 228).withOpacity(0.5), // Adjust the color and opacity
                          blurRadius: 15,
                          spreadRadius: 10,
                          offset: Offset(1,3),
                      )]
                ...
                InkWell(
                  onTap: () {
                    Navigator.pushNamed(context, '/cocuk');
                  },
                  child: Container(
                    width: 150,
                    height: 200,
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                        color:  Color.fromARGB(255, 223, 11, 156).withOpacity(0.5), // Adjust the color and opacity
                          blurRadius: 15,
                          spreadRadius: 10,
                          offset: Offset(1,3),
                      )]
